...
<Label className="mt-4" style={{gridColumnStart:2,gridColumnEnd:4}}>
          <span>الجنسية</span>
          <Input className="mt-1" value={nationality} onChange={(e)=>setNationality(e.target.value)} />
        </Label>
<Label className="mt-4">
...
<Label className="mt-4">
          ...
          <Input className="mt-1" value={maritalStatus} type="text" onChange={e=>setMaritalStatus(e.target.value)} />
        </Label>
...
<Label className="mt-4">
          ...
          <Input className="mt-1" value={degreeSentific} onChange={e=>setDegree(e.target.value)}/>
        </Label>
